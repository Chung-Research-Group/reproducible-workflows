function derivatives = FuncCnCDepressurization(~, state_vars, params, MPDParams, LN_Pi, Ene, state_rd)
%#codegen
...
%   1.1) Calculate equilibrium molar loading
    q   = calculate_N_loads(y, 1-y, P*P_0/1e5, T*T_0, LN_Pi, Ene, state_rd, NumOfCom1, NumOfCom2, Cell_a, Cell_b, Cell_c) ;
    q_1 = q(:, 1)*Unit*ro_s                               ;
    q_2 = q(:, 2)*Unit*ro_s                               ;
%   
%%  
...
%   
%%  
    generation_term_1 = (1-epsilon).*q_s0.*(-deltaU_1)./T_0 ;
    generation_term_2 = (1-epsilon).*q_s0.*(-deltaU_2)./T_0 ;
