function [ objectives, constraints ] = PSACycleSimulation( x, type, N)
    ...
    process_variables = [1, x(1), x(1)*x(4)/8.314/298.15,  x(2),  x(3),  x(5), 1e4, x(6), x(7), x(8)] ;
	
	try
    [objectives, constraints] = PSACycle(process_variables, [], type, N) ;
	catch
