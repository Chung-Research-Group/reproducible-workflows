...
if 1:
    ...
    last_three_elements = unique_elements[-3:]

    mask_last3 = [s in last_three_elements for s in original_symbols]
    mask_not_last3 = [not m for m in mask_last3]

    atoms_last3 = atoms[mask_last3]
    atoms_not_last3 = atoms[mask_not_last3]

    write(os.path.join(opt_output_dir, f'{struc_name}_guest.cif'), atoms_last3)
    write(os.path.join(opt_output_dir, f'{struc_name}_host.cif'), atoms_not_last3)
